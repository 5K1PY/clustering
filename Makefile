...
visuals:
	...
	./visualizer.py data/gen/gen_n1000_d5.in --title "Generated dataset (N=1000, D=5)" --save img/gen_n1000_d5.svg
	...
	./visualizer.py data/gen/gen_n1000_d5.in data/gen/gen_n1000_d5.facility_set_z1.face_hashing.9a7aa40.out --title "Generated dataset (N=1000, D=5) — Face hashing" --save img/gen_n1000_d5_fl_face_hashing.svg

	./visualizer.py data/gen/gen_n1000_d10.in --title "Generated dataset — N=1000, D=10" --save img/gen_n1000_d10.svg
	./visualizer.py data/gen/gen_n1000_d10.in --title "Generated dataset (N=1000, D=10) — Mettu-Plaxton" --save img/gen_n1000_d10.svg
	./visualizer.py data/gen/gen_n1000_d10.in --title "Generated dataset (N=1000, D=10) — Face hashing" --save img/gen_n1000_d10.svg
